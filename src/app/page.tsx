    ...
    <div className="min-h-screen bg-[#000000] text-[#ededed] font-sans selection:bg-[#24b47e]/30">
      ...
      <header className="relative z-50 border-b border-[#333333] bg-[#000000]/50 backdrop-blur-md px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 items-center">
          ...
          <Link href="/login" className="px-4 py-1.5 rounded text-sm font-medium border border-[#333333] bg-[#1a1a1a] text-white hover:border-[#24b47e] hover:text-[#24b47e] transition-all">
            Get Started
          </Link>
        </div>
      </header>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center pt-32 pb-16 px-4 text-center max-w-4xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#24b47e]/30 bg-[#24b47e]/10 text-xs font-medium text-[#24b47e] mb-8">
        ...
        <Link href="/login" className="group flex items-center gap-2 px-8 py-3 rounded-md text-base font-medium border border-[#333333] bg-[#111111] hover:border-[#24b47e] hover:bg-[#24b47e]/5 transition-all text-[#ededed]">
          Start for free
          <svg className="w-4 h-4 text-[#a1a1aa] group-hover:text-[#24b47e] group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
