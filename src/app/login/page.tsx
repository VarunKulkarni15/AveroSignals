      ...
      <div className="w-full max-w-[400px] bg-[#111111] border border-[#333333] rounded-lg p-8 shadow-2xl">
        ...
        <div className="flex flex-col gap-3 mb-6">
          <form action={signInWithGoogle}>
            <button type="submit" className="w-full flex items-center justify-center gap-3 px-4 py-2 rounded-md border border-[#333333] bg-[#1a1a1a] hover:bg-[#222222] text-[#ededed] text-sm font-medium transition-colors">
